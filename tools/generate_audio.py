...
# Các hàm Core
# ==========================
def append_tone(frames, frequency, duration, volume=0.25): # Giảm volume xuống chút cho đỡ chói tai
...
while True:
    ...
    if choice == '1':
        ...
        if last_selected == '1': start_f1 += step; start_f2 += step
        elif last_selected == '2': success_f1 += step; success_f2 += step
        elif last_selected == '3': error_f1 += step; error_f2 += step
